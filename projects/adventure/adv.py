...
while len(graphMap) < len(roomGraph):
    ...
    if len(breadCrumbsToStart):
        lastRoomDir = breadCrumbsToStart[len(breadCrumbsToStart) - 1]
        lastRoom = room.getRoomInDirection(lastRoomDir)
        graphMap[room.id][lastRoomDir] = lastRoom.id
